...
<html lang="en">
  <head>
    ...
    <!-- Awesome Fonts -->
    <link href="//fonts.googleapis.com/css?family=Lato:100,200,300,400,700,900,300italic,400italic,700italic,900italic" rel="stylesheet" type="text/css">
  ...
  <body>
    <a href="/">
    <img src="/img/logo_small.png" alt="Lightbulb :)" id="logo">
    </a>
    <div class="container">
        
        <h1>LIGHTBULB</h1>
        <h3>Connects Students and Teachers</h3>
        <br>
        <p>Lightbulb is the new way to connect teachers to students. Instead of relying on homework scores or guesswork, watch in real-time as students use the simple three button interface to communicate their understanding.</p>
